...
class MSCRED(nn.Module):
    def __init__(self, feats, window):
        ...
        self.encoder = nn.ModuleList([
			ConvLSTM(1, 8, (3, 3), 1, True, True, False),
			ConvLSTM(8, 16, (3, 3), 1, True, True, False),
			ConvLSTM(16, 32, (3, 3), 1, True, True, False),
			]
		)

        self.decoder = nn.Sequential(
			nn.ConvTranspose2d(32, 4, (3, 3), 1, 1), nn.ReLU(True),
			nn.ConvTranspose2d(4, 4, (3, 3), 1, 1), nn.ReLU(True),
